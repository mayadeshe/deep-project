"""
pipeutils.py — Shared utilities for all inpainting pipelines.

Provides:
  - select_device()          MPS / CPU selection
  - preprocess_inputs()      Load + resize image and mask (supports .pt masks)
  - load_sd_pipeline()       StableDiffusionPipeline + DDIMScheduler
  - DEFAULT_NEGATIVE_PROMPT  Standard artifact-suppression negative prompt
"""
...
def load_sd_pipeline(device: str) -> StableDiffusionPipeline:
    """
    StableDiffusionPipeline with DDIMScheduler.
